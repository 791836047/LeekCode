...
public class LeekCode415 {
    ...
    public static void main(String[] args) {
        System.out.println(addStringsTest("456","77"));
    }
    ...
    public static String addStrings(String num1, String num2) {
        ...
        while (i >= 0 || j >= 0 || add != 0) {
            //“字符型减字符'0'可以得到整数型”,在指针当前下标处于负数的时候返回 0，等价于对位数较短的数字进行了补零操作
    ...
    public static String addStringsTest(String num1, String num2) {
        int n1 = num1.length() -1;
        int n2 = num2.length() -1;
        int ans = 0;

        StringBuilder stringBuilder = new StringBuilder();
        while(n1 >= 0 || n2 >= 0 || ans!=0){
            int v1 = n1 >=0 ? num1.charAt(n1) - '0' : 0;
            int v2 = n2 >=0 ? num1.charAt(n2) - '0' : 0;
            int yu = (v1 + v2) % 10 + ans;
            ans = (v1 + v2)/10;
